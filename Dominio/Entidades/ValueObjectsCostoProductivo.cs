namespace CostManagement.Dominio.Entidades
{
    public static class ValueObjectsCostoProductivo
    {
        ...
        public const string spConfiguracionCostoProductivoCostos =
            "costos.sp_costoProductivo_configuracion";
        public const string spConfiguracionCostoProductivoMatEmpaque =
            "costos.sp_costoProductivo_materialEmpaque_configuracion";
